          ...
          >
            {uploadedFiles.length > 0 ? (
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm text-gray-500">Click or drop to upload {multiple ? 'more' : 'another'}</p>
              </div>
            ) : (
              <div className="flex flex-col items-center">
                ...
                <p className="font-medium text-gray-700 mb-1">Drag & drop or click to upload</p>
