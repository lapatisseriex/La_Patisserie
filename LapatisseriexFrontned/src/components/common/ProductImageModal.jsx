...
const ProductImageModal = ({ 
  ...
  return (
    <div 
      ref={modalRef}
      className={`modal-backdrop fixed inset-0 z-50 flex items-center justify-center transition-all duration-300 ease-out ${
        isVisible 
    ...
    >
      ...
      <div 
        className={`relative max-w-[95vw] max-h-[95vh] transition-all duration-300 ease-out ${
          isVisible 
      ...
      >
        ...
        >
          <img
            ...
            className={`
              block w-auto h-auto max-w-[90vw] max-h-[85vh] 
              md:max-w-[85vw] md:max-h-[80vh]
          ...
          {/* Zoom Indicator */}
          {!isZoomed && (
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-black/10 rounded-2xl">
        ...
        {/* Image Counter */}
        {images.length > 1 && (
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-black/40 backdrop-blur-sm text-white px-3 py-1.5 rounded-full text-sm font-medium">
