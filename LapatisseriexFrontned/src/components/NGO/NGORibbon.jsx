        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-5 sm:gap-8">
          ...
          <div className="flex items-center gap-4 sm:gap-5 text-[#733857]">
            ...
            <div className="transform group-hover:translate-x-1 transition-transform duration-300">
              <h2 className="text-2xl font-light tracking-wide" style={{ color: '#733857', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
          ...
          {/* Donate Button */}
          <div className="bg-[#733857] text-white px-7 sm:px-9 lg:px-10 py-3.5 sm:py-4 lg:py-4.5 font-medium text-base lg:text-lg hover:shadow-2xl hover:scale-105 hover:bg-[#8b4567] transition-all duration-300 flex items-center gap-2.5 flex-shrink-0" style={{ fontFamily: 'system-ui, -apple-system, sans-serif', letterSpacing: '0.03em' }}>
            <span style={{ fontWeight: 500 }}>Donate Now</span>
