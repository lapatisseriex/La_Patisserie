          ...
          <div className="space-y-4">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={email}
                    disabled={true}
                    className="w-full pl-10 pr-3 py-3 border rounded-md bg-gray-50 text-gray-700"
                  />
                </div>
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center gap-2 text-green-800 text-sm">
                <CheckCircle2 size={16}/> Your email is already verified and secure! No additional verification needed.
              </div>
            </div>
          </div>
        ) : (
