  ...
  if (!isAuthenticated) {
    return (
      <div className="max-w-4xl mx-auto py-12 px-4 text-center">
        <h1 className="text-2xl font-bold mb-4 text-[#733857]" style={{  }}>Please Log In</h1>
        <p className="mb-6 text-gray-600" style={{  }}>You need to be logged in to access the checkout page.</p>
        <style>{`
